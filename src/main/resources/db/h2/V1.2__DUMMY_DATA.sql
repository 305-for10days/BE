...
-- INSERT INTO user_routine (id, created_at, updated_at, calorie, exercise_goal_id, user_id)
-- VALUES (6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 100,  1, 1),
--        (7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 150,  2, 1),
--        (8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 120,  3, 1),
--        (9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 90,  4, 1),
--        (10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 110,  5, 1),
--         (11, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 100,  1, 2),
--        (12, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 150,  2, 2),
--        (13, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 90,  4, 2);
